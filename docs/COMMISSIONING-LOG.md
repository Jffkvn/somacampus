...
| 22 | Auto-billing + allocation uniqueness + Today retry | 2026-09-12 | New enrolments auto-billed from approved price list (live-proven, fail-safe); pair-unique index stops allocation pile-up; Today error card retries. INCIDENT: uniqueness repair over-archived 6 pairs — restored, 9/9 live, index proven. |
| 21 | Sarah-via-wizard regen + bypass rule live | 2026-09-12 | Attestation rule verified live (3 branches); Sarah allocated Stage 5 Science with lineage, week regenerated (36, spread 8/7/7/7/7) and published with real scorecard; exactly one active timetable. David loses Stage 5 Science (product call). |
| 20 | Week-grid redesign + solver spread + lunch fix | 2026-09-11 | Solver now spreads Mon–Fri (day-load ordering; Friday fills). Shared `WeekGrid`: periods-as-rows × days-as-cols, full-width break/lunch bands, subject colors, per-class view. Lunch 13:00–14:00. Pending your retest. |
