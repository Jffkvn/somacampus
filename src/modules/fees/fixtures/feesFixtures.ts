import { FeeAccountSummaryItem } from '../feesService';

export const INITIAL_FEE_ACCOUNTS: FeeAccountSummaryItem[] = [
  {
    id: 'fee-001',
...
export const feesFixtureStore = {
  accounts: [...INITIAL_FEE_ACCOUNTS],
  reset() {
    this.accounts = [...INITIAL_FEE_ACCOUNTS];
  },
};
