...
const SEED_RESOURCES: AcademicResource[] = [
  {
    id: 'res-01',
    ...
    curriculumObjective: '5Nn.03: Convert between improper fractions and mixed numbers; represent decimal tenths and hundredths.',
    ...
    tags: ['bar-models', 'scaffolded', 'decimals', 'differentiation'],
  },
  {
    id: 'res-02',
    ...
    curriculumObjective: '6Wn.02: Structure persuasive texts with clear arguments, logical connectives, and rhetorical questioning.',
    approvalState: 'school_approved',
  ...
  {
    id: 'res-03',
    title: 'Plant Cell Microscopy & Osmosis Investigation',
    type: 'lab_guide',
    subject: 'Science',
    stageLevel: 'Stage 5',
    topic: 'Living Things & Cells',
    curriculumObjective: '5Bs.01: Identify plant cell structures including cell wall, vacuole, and chloroplasts under magnification.',
    approvalState: 'school_approved',
    author: 'James Kato',
...
export const ResourceLibraryPage: React.FC = () => {
  const [resources, setResources] = useState<AcademicResource[]>(SEED_RESOURCES);
