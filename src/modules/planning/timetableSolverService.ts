...
export const timetableSolverService = {
  ...
  generateStandardPeriods(): SolverPeriodSlot[] {
    ...
    // 1-hour lunch 13:00-14:00. Break/lunch bands render in grids separately.
    const periodTimes = [
      ...
      { start: '12:15', end: '13:00', isMorning: false },
      { start: '14:00', end: '14:45', isMorning: false }, // Post lunch
